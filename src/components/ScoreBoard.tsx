      ...
      <div className="space-y-2">
        <div className="flex justify-between items-center p-2 bg-indigo-50 rounded">
          <div className="flex items-center gap-2">
            ...
            <span className="font-medium">BETECH</span>
          </div>
...
<<<<<<< HEAD
            <span className="font-medium">DEVOPS ENTERPRISE</span>
=======
            <span className="font-medium">BJ ENTERPRISE</span>
>>>>>>> d7e6c40 (Change Scoreboard name)
          </div>
